                          ...
                          <div className="card-content">
                            <div className="media">
                              <div className="media-content">
                                <Links to="" className="title is-4 is-underlined has-text-centered">Who we are</Links>
                      ...
                      <div className="column is-one-third">
                        <div className="card">
                          ...
                          <div className="card-content">
                            <div className="media">
                              <div className="media-content">
                                <Links to="" className="title is-4 is-underlined has-text-centered">What we do</Links>
                                <CardParagraph className="has-text-left">
                      ...
                      <div className="column is-one-third">
                        <div className="card">
                          ...
                          <div className="card-content">
                            <div className="media">
                              <div className="media-content">
                                <Links to="" className="title is-4 is-underlined has-text-centered">Our Values</Links>
                                <CardParagraph className="has-text-left">
